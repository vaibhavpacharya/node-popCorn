...
router.get("/",function(req,res){
    var popular = urls.popular +apiKey;
    // load initial main movie
        request(popular, function(err,response,body){
          if(err){
            console.log(err);
          }
          else{
                    ...
                    request(recommendations, function(err, movieRecommendations){
                      if(err){
                        ...
                        // console.log(recommend);
                            request(popular, function(err, moviePopular){
                            if(err){
                              console.log(err);
                            } else {
                              var currPopular = JSON.parse(moviePopular.body);
